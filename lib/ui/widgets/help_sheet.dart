    ...
    return switch (topic) {
      HelpTopic.home => const HelpContent(
          ...
          sections: [
            ...
            HelpSection(
              title: 'שני מצבי האימון',
              body:
                  '• אימון אקורד בודד — תרגול ממוקד של אקורד אחד שבחרתם, עם משוב חי מהמיקרופון.\n'
                  '• אימון מעברי אקורדים — תרגול מעבר בין שני אקורדים לפי מטרונום וקצב.',
            ),
            HelpSection(
      ...
      HelpTopic.chordLibrary => const HelpContent(
          ...
          sections: [
            ...
            HelpSection(
              title: 'איך משתמשים?',
              body:
                  '1. לוחצים על כרטיס אקורד (למשל C, Dm, Em).\n'
                  '2. נפתחת חלונית עם דיאגרמה מוגדלת של האחיזה.\n'
                  '3. אפשר לסגור ולעבור לאקורד אחר.',
            ),
            HelpSection(
              ...
              body:
                  ...
                  '• X — מיתר מושתק (לא לנגן).\n'
                  '• עיגול עם מספר — ללחוץ על הסריג הזה במיתר הזה.\n'
                  'המיתרים משמאל לימין: 6 (עבה) → 1 (דק).',
            ),
            HelpSection(
              title: 'טיפ למתחילים',
              body:
